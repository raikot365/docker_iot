...
Para la implementación se utilizó el atributo "data-bs-theme" que permite cambiar los modos en el elemento <html> de manera global o en un componente y elemento especifico ([text](https://getbootstrap.com/docs/5.3/customize/color-modes/)). En ese caso se utilizó el atributo dentro de la etiqueta <body data-bs-theme="ligth or dark">, donde se realizó una lógica con jinja para seleccionar el tema.
